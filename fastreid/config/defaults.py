...
_C.MODEL.PIXEL_MEAN = [0.3525*255, 0.3106*255, 0.314*255]
# Values to be used for image normalization
# _C.MODEL.PIXEL_STD = [0.229*255, 0.224*255, 0.225*255]
_C.MODEL.PIXEL_STD = [0.266*255, 0.2522*255, 0.2505*255]
...
_C.INPUT.REA.MEAN = [0.3525*255, 0.3106*255, 0.314*255] #[123.675, 116.28, 103.53] [0.3525*255, 0.3106*255, 0.314*255]
# Random Patch
_C.INPUT.RPT = CN()
