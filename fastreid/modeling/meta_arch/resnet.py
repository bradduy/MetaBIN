...
class ResNet(nn.Module):
    def __init__(self, last_stride, bn_norm, norm_opt, num_splits, with_ibn, with_se, with_nl, block, layers, non_layers):
        ...
        # # N*64*128*64
        # self.en_conv2 = _make_layer_encode(ngf, ngf*2)
        # # N*128*64*32
        # self.en_conv3 = _make_layer_encode(ngf*2, ngf*4)
        # # N*256*32*16
        # self.en_conv4 = _make_layer_encode(ngf*4, ngf*8)
        # # N*512*16*8
        # self.en_conv5 = _make_layer_encode(ngf*8, ngf*8)
        # # N*512*8*4
